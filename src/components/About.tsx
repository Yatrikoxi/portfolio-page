      ...
      <div className='about h-screen w-full bg-gradient-to-t from-black via-black to-cyan-950'>
        <div className='max-w-screen-lg p-4 mx-auto flex flex-col w-full h-full justify-center'>
          <div className='pb-8 text-gray-100'>
            ...
            <p className='text-md md:text-xl mt-20'>
            ...
            <p className='text-md md:text-xl'>
              ...
              aktivně vzdělávat v oboru Web developmentu se snem pracovat s
              technoligií React. <br />
              ...
              , Full stack JS the Odin Project a React 18 od{" "}
              <a
